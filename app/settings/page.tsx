...
export default function SettingsPage() {
  const [profileData, setProfileData] = useState({
    ...
    bio: "First human to walk on the Moon. Space exploration enthusiast.",
    location: "Houston, TX",
    website: "https://neilarmstrong.com",
  })
                  ...
                  <CardContent className="text-center">
                    <div className="relative inline-block mb-4">
                      <Avatar className="w-24 h-24">
                        ...
                        <AvatarFallback className="bg-cosmic-purple/20 text-cosmic-purple text-2xl">NA</AvatarFallback>
                      </Avatar>
                      <Button
                        size="sm"
